...
cuidades = ["quito1","ibarra2","cayambe3"]
for ciudad_set,cuidad in enumerate(temperaturas):
    for semana_set,semana  in enumerate (cuidad):
        suma_temperaturas= sum([dia["temp"] for dia in semana])
        promedio = suma_temperaturas/len(semana)
        print(f"promedio de las temperaturas {cuidades[cuidad_set]} , semanas {semana_set +4}, promedio {promedio}")
